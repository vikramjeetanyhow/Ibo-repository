...
interface ProductInterface extends \Magento\Framework\Api\CustomAttributesDataInterface
{
     ...
     * @return string
     */
    public function getl10nInHsnCode();

    /**
     * Sets list of HSN code
     *
     * @return $this
     */
    public function setl10nInHsnCode($hsnCode);
    ...
    /**
     * Sets list of Brand Name
     *
     * @return $this
     */
    public function setBrandName($brandId);
    ...
    * @return string
    */
    public function getSaleUom();

     /**
    * Sets list of Sale UOM
    *
    * @return $this
    */
    public function setSaleUom($saleUOM);
}
