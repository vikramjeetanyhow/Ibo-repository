                ...
                if(empty($outletData)){
                    if($id) {
                        ...
                        $query1 = $connection->update($outletTable,
                            ...
                            'online_payment_popup_status'=> $data['general']['online_payment_popup_status'], 'display_payments'=> $data['general']['display_payments'], 'partial_cart_total_limit'=> $data['general']['partial_cart_total_limit'], 'partial_dwh_total_limit'=> $data['general']['partial_dwh_total_limit'], 'multi_lot_status'=> $data['general']['multi_lot_status']], $where1 );
