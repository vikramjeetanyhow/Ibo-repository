...
class Salessummary extends \Magento\Backend\App\Action
{
	...
	public function execute()
	{
		...
		if($assignedOutletIds != -1) {
			...
			$this->adminSession->setData("ah_report_from_date", $from);
			$this->adminSession->setData("ah_report_to_date", $to);
		...
		$resultPage->getConfig()->getTitle()->prepend(__('Sales Summary'));
		return $resultPage;
	} else{
