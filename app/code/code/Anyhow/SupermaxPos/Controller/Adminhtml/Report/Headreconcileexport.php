...
class Headreconcileexport extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($register_collection as $item) {
            ...
            $itemData[] = $partialBallanceExpected;
            $itemData[] = $partialBallanceTotal;
            $itemData[] = $partialBallanceDifference;
            $itemData[] = $item['head_cashier_partial_balance_total'];
            $itemData[] = ($partialBallanceExpected - $item['head_cashier_partial_balance_total']);
