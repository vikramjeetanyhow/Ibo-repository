...
class Data
{
    ...
    public function getIboPaymentOptions() {
        $data = array(
            ...
            "PARTIAL-PAYMENT-BALANCE" => array(
                "method" => "PARTIAL-PAYMENT-BALANCE",
                "code" => "PARTIAL-PAYMENT-BALANCE",
                "psp_id" =>$this->getConfig('ah_supermax_pos_configuration/ah_supermax_pos_ibo_payment_engine/ah_supermax_pos_ibo_psp_id', null),
                "payment_option_id" => $this->getConfig('ah_supermax_pos_configuration/ah_supermax_pos_ibo_payment_engine/ah_supermax_pos_partial_payment_option_id', null)
            )
        );
