                    ...
                    if(!empty($quoteOrder)) {
                        ...
                        if(!empty($params)){
                            ...
                            $orderData = [
                                ...
                                "is_partial_payment" => isset($params['is_partial_payment']) ? $params['is_partial_payment'] : false,
                            ];
                        }
    ...
    private function updateRegisterData($data) {
        ...
        switch ($paymentCode) {
            ...
            case 'BHARATPE':
                $this->helper->addRegisterTransaction($userId, 'pay_later', 'Pay Later Payment', $description, $total, $storeCurrencyCode, $storeBaseCurrencyCode, $storeId, $storeCurrencySymbol, $cashPaid, $cashReturned);
                break;    
            case 'PARTIAL-PAYMENT-BALANCE':
                $this->helper->addRegisterTransaction($userId, 'partial_payment_balance', 'Pay On Invoice Payment', $description, $total, $storeCurrencyCode, $storeBaseCurrencyCode, $storeId, $storeCurrencySymbol, $cashPaid, $cashReturned);
                break;
        }
    }
