...
class User implements \Anyhow\SupermaxPos\Api\Supermax\UserInterface
{
            ...
            if($tokenFlag) {
                ...
                if(!empty($userData)) {
                    ...
                    $userOutlet = array(
                        ...
                        'partial_payment_enable_limit' => html_entity_decode($user['partial_cart_total_limit']),
                        'partial_payment_dwh_limit' => html_entity_decode($user['partial_dwh_total_limit']),
    ...
    public function joinUserData($connection, $userId, $restroModuleStatus)
    {
        ...
        $select->from(
            ...
            ['outlet_name', 'outlet_address_type', 'allowed_ips', 'inventory_node', 'store_wh_node', 'outlet_store_id' => 'store_id','receipt_thermal_status', 'online_payment_popup_status' ,'display_payments', 'multi_lot_status', 'partial_cart_total_limit', 'partial_dwh_total_limit']
        )->joinLeft(
