...
class PostPromise implements \Anyhow\SupermaxPos\Api\Supermax\PostPromiseInterface
{
    ...
    public function postPromise() {
        ...
        try {
            ...
            if($tokenFlag) {
                ...
                $postPromiseApiUrl = $this->helper->getConfig("promise_engine/promise_engine_settings/promise_engine_api_url", $storeId = null);
                
                $apiResponse = $this->helper->curlPostRequest($postPromiseApiUrl, $params, $header, true, 'Post Promise');
