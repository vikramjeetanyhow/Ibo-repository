...
class SalesTax extends Column
{
    ...
    {      
        ...
        $salesOredrTable = $this->resource->getTableName('sales_order');
        ...
        if(isset($dataSource['data']['items'])) {
            ...
            foreach($dataSource['data']['items'] as & $item) {
                ...
                // $data = $connection->query("SELECT SUM(tax_amount) AS `tax` FROM $salesOredrTable WHERE (DATE(`created_at`) >= DATE('$dateStart') And DATE(`created_at`) <= DATE('$dateEnd'))")->fetch();
