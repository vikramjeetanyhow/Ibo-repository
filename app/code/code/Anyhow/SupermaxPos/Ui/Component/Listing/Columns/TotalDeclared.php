    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        if(isset($dataSource['data']['items'])) {
            ...
            foreach($dataSource['data']['items'] as & $item) {                
                ...
                $getHeadRegisterTotal = $connection->query("SELECT reconciliation_status, SUM(head_cashier_cash_total + head_cashier_card_total + head_cashier_custom_total + head_cashier_offline_total + head_cashier_wallet_total + head_cashier_emi_total + head_cashier_bank_deposit_total + head_cashier_pay_later_total + head_cashier_partial_balance_total) as total_total FROM $supermaxRegister WHERE pos_register_id = '" .$posRegisterId. "'")->fetch();
