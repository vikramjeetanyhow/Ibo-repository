                ...
                if (isset($dataSource['data']['items'])) {
                    ...
                    foreach ($dataSource['data']['items'] as &$item) {
                        ...
                        if ($payment_method == 'cash') {
                            ...
                            $item[$fieldName] = $storeCurrencySymbol . round($cashTotal, 2);
                            ...
                            $item[$fieldName] = $storeCurrencySymbol . round($cardTotal, 2);
                           ...
                           $item[$fieldName] = $storeCurrencySymbol . round($customTotal, 2);
                           ...
                           $item[$fieldName] = $storeCurrencySymbol . round($offlineTotal, 2);
                            ...
                            $item[$fieldName] = $storeCurrencySymbol . round($walletTotal, 2);
                           ...
                           $item[$fieldName] = $storeCurrencySymbol . round($emiTotal, 2);
                           ...
                           $item[$fieldName] = $storeCurrencySymbol . round($bankDepositTotal, 2);
                           ...
                           $item[$fieldName] = $storeCurrencySymbol . round($payLaterTotal, 2);
                        } else {
                            ...
                            $item[$fieldName] = $storeCurrencySymbol . round($total, 2);
                        }
