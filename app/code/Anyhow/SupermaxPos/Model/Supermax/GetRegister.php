...
class GetRegister implements \Anyhow\SupermaxPos\Api\Supermax\GetRegisterInterface
{
    ...
    public function getRegister()
    {
        ...
        try {
            ...
            if($tokenFlag) {
                ...
                $registerData = $this->helper->getTotalRegisterData($userId, $status = 1, $storeId, $storeName, $storeCurrencyCode, $storeBaseCurrencyCode, $storeCurrencySymbol, $flag = true);
