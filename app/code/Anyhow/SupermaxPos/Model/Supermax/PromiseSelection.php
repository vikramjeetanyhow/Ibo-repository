...
class PromiseSelection implements \Anyhow\SupermaxPos\Api\Supermax\PromiseSelectionInterface
{
     ...
     * @return string
     */
    public function promiseSelection() {
        $result = array();
        $error = false;
        try {
            ...
            if($tokenFlag) {
                ...
                $apiResponse = $this->helper->curlPostRequest($baseUrl . 'promise/' . $params['promise_id'] . '/selection', $params, $header, true, 'Promise Selection');
