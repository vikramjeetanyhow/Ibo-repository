...
class RegisterRepository implements RegisterRepositoryInterface
{
    ...
    public function save(\Anyhow\SupermaxPos\Api\Data\RegisterInterface $receipt)
    {
    ...
    public function delete(\Anyhow\SupermaxPos\Api\Data\RegisterInterface $receipt)
    {
        try {
