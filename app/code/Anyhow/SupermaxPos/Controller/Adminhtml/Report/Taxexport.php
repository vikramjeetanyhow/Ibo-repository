...
class Taxexport extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Anyhow\SupermaxPos\Model\ResourceModel\SupermaxReportTax\Collection $registerData,
    ...
    {   
        ...
        $filepath = 'export/tax-report-import-' .$name. '.csv';
        $this->directory->create('export');

        $stream = $this->directory->openFile($filepath, 'w+');
        $stream->lock();

        $columns = ['Date Start','Date End','Tax Title','No. Orders','Total'];
        ...
        foreach($register_collection as $item){
            ...
            $itemData[] = $storeCurrencySymbol.$item['total'];
        ...
        $csvfilename = 'tax-report-import-'.$name.'.csv';
