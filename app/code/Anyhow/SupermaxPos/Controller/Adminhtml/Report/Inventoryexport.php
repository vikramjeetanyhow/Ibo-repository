...
class Inventoryexport extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Anyhow\SupermaxPos\Model\ResourceModel\SupermaxInventory\Collection $registerData,
    ...
    {   
        ...
        $filepath = 'export/inventory-report-import-' .$name. '.csv';
        $this->directory->create('export');

        $stream = $this->directory->openFile($filepath, 'w+');
        $stream->lock();

        $columns = ['Date Start','Date End','Product Name','Sku','Current Stock','Quantity Sold', 'Total ('.$storeCurrencyCode.')'];
        ...
        $csvfilename = 'inventory-report-import-'.$name.'.csv';
