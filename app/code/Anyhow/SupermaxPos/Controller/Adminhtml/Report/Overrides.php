...
class Overrides extends \Magento\Backend\App\Action
{
	...
	public function execute()
	{
		...
		if($assignedOutletIds != -1) {
			...
			$resultPage->getConfig()->getTitle()->prepend(__('Overrides Report'));
			return $resultPage;
		} else{
			// $this->messageManager->addError(__('you do not have access. Please contact to admin to assign a store.'));
				/** \Magento\Backend\Model\View\Result\Redirect $resultRedirect */
				$resultRedirect = $this->resultRedirectFactory->create();
				return $resultRedirect->setPath('supermax/report/nostoreoverride');
		}
