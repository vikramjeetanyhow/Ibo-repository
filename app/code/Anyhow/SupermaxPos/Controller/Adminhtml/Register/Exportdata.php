...
class Exportdata extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($register_collection as $item) {
            ...
            //pod expected
            // $getpodTotalExpected = $connection->query("SELECT SUM(amount) as expected_total FROM $supermaxRegisterTransDetailTable WHERE pos_register_id = '" .$posRegisterId. "' AND code = 'pod' ");
            // foreach($getpodTotalExpected as $getpodExpected) {
            //     $podExpected = (float)$getpodExpected['expected_total'];
            // }
            // total total
            ...
            // pod total
            // $getpodRegisterTotal = $connection->query("SELECT SUM(total) as total_total FROM $supermaxRegisterTransTable WHERE pos_register_id = '" .$posRegisterId. "' AND code = 'pod' ");
            // foreach($getpodRegisterTotal as $getpodTotal) {
            //     $podTotal = (float)$getpodTotal['total_total'];
            // }
            ...
            // POD difference
            // $getpodRegisterDifference = $connection->query("SELECT SUM(difference) as difference_total FROM $supermaxRegisterTransTable WHERE pos_register_id = '" .$posRegisterId. "' AND code = 'pod' ");
            // foreach($getpodRegisterDifference as $getpodDifference) {
            //     $podDifference = (float)$getpodDifference['difference_total'];
            // }
            ...
            // $getbankDepositRegisterDifference = $connection->query("SELECT SUM(difference) as difference_total FROM $supermaxRegisterTransTable WHERE pos_register_id = '" . $posRegisterId . "' AND code = 'bank_deposit' ");
            // foreach ($getbankDepositRegisterDifference as $getbankDepositDifference) {
            //     $bankDepositDifference = (float) $getbankDepositDifference['difference_total'];
            // }
            ...
            // $itemData[] = $podExpected;
            // $itemData[] = $podTotal;
            // $itemData[] = $podDifference;
            // $itemData[] = $item['head_cashier_pod_total'];
            // $itemData[] = ($podExpected - $item['head_cashier_pod_total']);
