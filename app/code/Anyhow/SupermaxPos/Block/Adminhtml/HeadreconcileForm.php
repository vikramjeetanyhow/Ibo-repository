 ...
 * @since 100.0.2
 */
class HeadreconcileForm extends \Magento\Backend\Block\Template
{
    ...
    public function getAdminUrl(){
        return $this->getUrl('supermax/report/headreconcilesave');
    }
    ...
    public function getReconcoleStatus(){
        $reconcile_status = array(
			'Pending' => 'Pending',
			'Done' => 'Done',           
		);    	
    ...
    public function getAllPaymentMethods(){
        $payment_methods = array(
            ...
            'emi' => 'EMI Payment',
            'bank_deposit' => 'Bank-Deposit Payment',
