...
class OverrideDiscountType extends Column
{
    /**
    ...
    {     
        ...
        if(isset($dataSource['data']['items'])) {
            ...
            foreach($dataSource['data']['items'] as & $item) {
                if (isset($item[$fieldName]) && array_key_exists($item[$fieldName], $discountType)) {
                    $item[$fieldName] = $discountType[$item[$fieldName]];
                } else {
                    $item[$fieldName] = 'N/A';
                }
            }
