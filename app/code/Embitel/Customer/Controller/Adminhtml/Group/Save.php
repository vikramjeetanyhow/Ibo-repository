 ...
 */
namespace Embitel\Customer\Controller\Adminhtml\Group;
        ...
        if ($taxClass) {
            ...
            try {
                ...
                if ($id !== null) {
                    ...
                    $customerCampaignId = (int)$this->getRequest()->getParam('customer_campaign_id');
                    $customerCampaignLabel = $this->getRequest()->getParam('campaign_label');
                    $updateQuery = "UPDATE customer_group SET customer_campaign_id = " . $customerCampaignId 
                                    . ",campaign_label='" . $customerCampaignLabel . "' WHERE customer_group_id = " . $id;
