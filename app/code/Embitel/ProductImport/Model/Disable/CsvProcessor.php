...
use Embitel\ProductImport\Model\EboDisableFactory;
...
{
    /**
     * @var \Embitel\ProductImport\Model\EboDisableFactory
     */
    protected $eboDisableFactory;
     ...
     * @param EboDisableFactory $eboDisableFactory
    ...
    public function __construct(
        ...
        EboDisableFactory $eboDisableFactory,
        ...
        $this->eboDisableFactory = $eboDisableFactory;
    }
    ...
    public function prepareResponse($products)
    {
        ...
        $ebodisable = $this->eboDisableFactory->create();
        $ebodisable->addData([
    ...
    {
        return $this->backendUrl->getUrl("productimport/disable/download", ['filename' => $status]);
    }
