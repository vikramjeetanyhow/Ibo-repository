...
namespace Embitel\ProductImport\Controller\Adminhtml\EboDisable\File;
...
class Download extends Action implements HttpGetActionInterface
{
     ...
     */
    const URL = 'productimport/ebodisable_file/download/';
    ...
    public function execute()
    {
        try {
            ...
            $destination = $dir . "/export/ProductDisable.zip";
            $disableDir = $dir . "/export/";                  
            $zip = new \ZipArchive();
            $zip->open($destination, \ZipArchive::CREATE | \ZipArchive::OVERWRITE);
            
            foreach ($postData as $key => $fileName) {
                $filename = $disableDir. $fileName;
