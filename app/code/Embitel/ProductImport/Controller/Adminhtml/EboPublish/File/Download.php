...
namespace Embitel\ProductImport\Controller\Adminhtml\EboPublish\File;
...
class Download extends Action implements HttpGetActionInterface
{
     ...
     */
    const URL = 'productimport/ebopublish_file/download/';
    ...
    public function execute()
    {
        try {
            ...
            $destination = $dir . "/export/ProductPublish.zip";
            $publishDir = $dir . "/export/";                  
            $zip = new \ZipArchive();
            $zip->open($destination, \ZipArchive::CREATE | \ZipArchive::OVERWRITE);
            
            foreach ($postData as $key => $fileName) {
                $filename = $publishDir. $fileName;
