...
use Embitel\ProductImport\Model\ResourceModel\EboDisable\CollectionFactory;

/**
 * Data provider for export grid.
 */
class DisableFileDataProvider extends DataProvider
{
    /**
    ...
    {   
        ...
        $collection = $this->eboCollection->create()
                ->addFieldToSelect(['success_filename', 'failure_filename'])               
