...
namespace Embitel\ProductFilter\Model\Resolver\Products\Query;
...
class Search extends \Magento\CatalogGraphQl\Model\Resolver\Products\Query\Search
{
    ...
    public function __construct(
        ...
        parent::__construct($search, $searchResultFactory, $pageSize, $fieldSelection, $productsProvider, $searchCriteriaBuilder);
    ...
    public function getResult(
        ...
        if (isset($args['search'])) {
            $this->registry->register('isSearch', true);
        }
