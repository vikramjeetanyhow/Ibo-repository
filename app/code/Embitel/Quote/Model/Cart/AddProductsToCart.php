...
namespace Embitel\Quote\Model\Cart;
...
class AddProductsToCart
{
     ...
     */
    public function execute($cart, array $cartItems, $postalCode): AddProductsToCartOutput
    {
        // $cartId = $this->maskedQuoteIdToQuoteId->execute($maskedCartId);
        // $cart = $this->cartRepository->get($cartId);

        foreach ($cartItems as $cartItemPosition => $cartItem) {
            $this->addItemToCart($cart, $cartItem, $cartItemPosition, $postalCode);
        }
     ...
     */
    private function addItemToCart($cart, $cartItem, int $cartItemPosition, $postalCode): void
    {
        $sku = $cartItem->getSku();
