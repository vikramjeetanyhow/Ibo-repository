 ...
 */
class ExtractCustomerAddressData extends \Magento\CustomerGraphQl\Model\Customer\Address\ExtractCustomerAddressData
{
    /**
    ...
    public function execute(AddressInterface $address): array
    {
        ...
        //$customerModel->getTaxvat();
        //$address->getCustomerId(); 
        if(($addressData['default_billing'] == 1) && ($customerModel->getTaxvat() != null) && ($customerModel->getTaxvat() != '') && ($customerModel->getTaxvat() != 'UNREGISTERED')) { 
            $addressData['is_gst'] = 1;
        } else {
            $addressData['is_gst'] = 0;
        }
