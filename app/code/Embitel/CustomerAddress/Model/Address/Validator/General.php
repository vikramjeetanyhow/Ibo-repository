 ...
 */
namespace Embitel\CustomerAddress\Model\Address\Validator;
...
class General extends \Magento\Customer\Model\Address\Validator\General
{
    ...
    {
        $errors = array_merge(
            $this->checkCustomRequiredFields($address),
     ...
     */
    private function checkCustomRequiredFields(AbstractAddress $address)
    {
        $errors = [];
