...
namespace Embitel\Importexportcategory\Block\Adminhtml\Exportcategory\Edit\Tab;
...
class Exportcategory extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $url = $this->getViewFileUrl('Embitel_Importexportcategory/embitel_categoryimport.zip');
