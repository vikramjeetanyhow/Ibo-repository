 ...
 */
/** MDVA-40601.patch applied */
declare(strict_types=1);

namespace Embitel\CatalogGraphQl\Model\Resolver\Products\DataProvider;

use Magento\CatalogGraphQl\Model\Category\Hydrator;
use Magento\Catalog\Api\Data\CategoryInterface;
use Magento\CatalogGraphQl\Model\Resolver\Products\DataProvider\ExtractDataFromCategoryTree as CategoryTreeExtractData;

/**
 * Extract data from category tree
 */
class ExtractDataFromCategoryTree extends CategoryTreeExtractData
{
    /**
     * @var Hydrator
     */
